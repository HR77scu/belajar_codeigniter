...
<div class="container-fluid">
	...
	<div class="row">
		<div class="col-sm-12">
            ...
            <div class="row">
                <div class="col-sm-4">
                    <button class="btn btn-block btn-primary" data-toggle="modal" data-target="#exampleModal" >Create menu</button>
                </div>
            </div>
            <br>
            <div class="row">
      ...
      <form action="<?= base_url('menu/submenu'); ?>" enctype="multipart/form-data" method="post">
          <div class="modal-body">
            <div class="form-group">
                ...
                <input type="text" placeholder="Input Menu" id="menu" name="menu" class="form-control">
            </div>
          </div>

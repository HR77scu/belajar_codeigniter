                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="p-5">
                            ...
                            <form class="user" method="post" entype="multipart/form-data" action="<?= base_url('auth/register/'); ?>">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="password" class="form-control form-control-user" name="confirm_password" id="cofirm_password" placeholder="Repeat Password">
